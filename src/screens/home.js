...
const Home = ({ navigation }) => {
  ...
  console.log('Admin Role ------>>> 🐦🐦🐦🐦' , auth.currentUser?.email)
  const [role, setrole] = React.useState(
    auth.currentUser !== null &&
      auth.currentUser.email === "maheradmin@gmail.com"
      ? "admin"
      : "user"
  );
              ...
              <Menu.Item
                ...
                title={
                  <View style={styles._row}>
                    ...
                    <Text style={styles._menue_text}>AddProduct</Text>
                  </View>
                }
              />
              <Divider />
              <Menu.Item
                ...
                title={
                  <View style={styles._row}>
                    ...
                    <Text style={styles._menue_text}>Logout</Text>
                  </View>
                }
              />
              <Divider />
